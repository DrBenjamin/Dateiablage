...
class MyFrame(wx.Frame):
    def __init__(self, parent, title, size, config):
        ...
        self.learning_ctrl = wx.ListCtrl(self.panel,
                                     style=wx.LC_REPORT
                                     |wx.BORDER_SUNKEN|wx.LIST_ALIGN_SNAP_TO_GRID)

        self.tasks_ctrl = wx.ListCtrl(self.panel,
                                     style=wx.LC_LIST
                                     |wx.BORDER_SUNKEN|wx.LIST_ALIGN_SNAP_TO_GRID
                                     )
        ...
        learning_title = wx.StaticText(self.panel, label = "e-Learning", style=wx.ALIGN_LEFT)
        task_title = wx.StaticText(self.panel, label = "Aufgaben", style=wx.ALIGN_RIGHT)
        explorer_title = wx.StaticText(self.panel, label = "Dateien und Ordner", style=wx.ALIGN_LEFT)
