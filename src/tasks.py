...
def on_import_excel(self, event):
    dialog = wx.FileDialog(self, "Importiere Aufgabenliste", wildcard="Excel- oder XML-Datei (*.xlsx;*.xml)|*.xlsx;*.xml|Alle Dateien (*.*)|*.*", style=wx.FD_OPEN | wx.FD_FILE_MUST_EXIST)
